...
import { ExperienceOfferingDetailPage } from "@/features/experiences/ExperienceOfferingDetailPage";
import {
...
export default async function ExperienciaSlugPage({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
  ...
  if (!item) notFound();
  return <ExperienceOfferingDetailPage item={item} />;
}
