...
export function normalizeHeroSettings(input: unknown, fallback?: Partial<CmsHeroSettings>): CmsHeroSettings {
  ...
  return {
    ...
    heroMediaPositionX: firstText(merged.heroMediaPositionX, defaultHeroSettings.heroMediaPositionX),
    heroMediaPositionY: firstText(merged.heroMediaPositionY, defaultHeroSettings.heroMediaPositionY),
    heroMediaScale: numOr(merged.heroMediaScale, 1),
    heroMediaTabletPositionX: firstText(merged.heroMediaTabletPositionX, merged.heroMediaPositionX, defaultHeroSettings.heroMediaTabletPositionX),
    heroMediaTabletPositionY: firstText(merged.heroMediaTabletPositionY, merged.heroMediaPositionY, defaultHeroSettings.heroMediaTabletPositionY),
    heroMediaTabletScale: numOr(merged.heroMediaTabletScale, merged.heroMediaScale, 1),
    heroMediaMobilePositionX: firstText(
      merged.heroMediaMobilePositionX,
      merged.heroMediaTabletPositionX,
      merged.heroMediaPositionX,
      defaultHeroSettings.heroMediaMobilePositionX,
    ),
    heroMediaMobilePositionY: firstText(
      merged.heroMediaMobilePositionY,
      merged.heroMediaTabletPositionY,
      merged.heroMediaPositionY,
      defaultHeroSettings.heroMediaMobilePositionY,
    ),
    heroMediaMobileScale: numOr(
      merged.heroMediaMobileScale,
      merged.heroMediaTabletScale,
      merged.heroMediaScale,
      1,
    ),
