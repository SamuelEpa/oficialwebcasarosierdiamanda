...
export function normalizeHeroSettings(input: unknown, fallback?: Partial<CmsHeroSettings>): CmsHeroSettings {
  ...
  return {
    ...
    heroLogoMobilePositionX: firstText(
      merged.heroLogoMobilePositionX,
      merged.heroLogoTabletPositionX,
      merged.heroLogoPositionX,
      defaultHeroSettings.heroLogoMobilePositionX,
    ),
    heroLogoMobilePositionY: firstText(
      merged.heroLogoMobilePositionY,
      merged.heroLogoTabletPositionY,
      merged.heroLogoPositionY,
      defaultHeroSettings.heroLogoMobilePositionY,
    ),
    heroLogoMobileWidth: firstText(
      merged.heroLogoMobileWidth,
      merged.heroLogoTabletWidth,
      merged.heroLogoWidth,
      defaultHeroSettings.heroLogoMobileWidth,
    ),
    ...
    heroMenuMobilePositionY: firstText(
      merged.heroMenuMobilePositionY,
      merged.heroMenuTabletPositionY,
      merged.heroMenuPositionY,
      defaultHeroSettings.heroMenuMobilePositionY,
    ),
    heroImage: firstText(merged.heroImage, defaultHeroSettings.heroImage),
    heroImageMobile: firstText(merged.heroImageMobile),
    heroVideoUrl: firstText(merged.heroVideoUrl),
    heroVideoUrlMobile: firstText(merged.heroVideoUrlMobile),
    heroVideoPoster: firstText(merged.heroVideoPoster),
    ...
    titleImageScaleMobile: numOr(merged.titleImageScaleMobile, merged.titleImageScaleTablet, merged.titleImageScale, 1),
    ...
    titleImagePositionXMobile: firstText(
      merged.titleImagePositionXMobile,
      merged.titleImagePositionXTablet,
      merged.titleImagePositionX,
      defaultHeroSettings.titleImagePositionXMobile,
    ),
    titleImagePositionYMobile: firstText(
      merged.titleImagePositionYMobile,
      merged.titleImagePositionYTablet,
      merged.titleImagePositionY,
      defaultHeroSettings.titleImagePositionYMobile,
    ),
    ...
    titleImageSecondaryScaleMobile: numOr(
      merged.titleImageSecondaryScaleMobile,
      merged.titleImageSecondaryScaleTablet,
      merged.titleImageSecondaryScale,
      1,
    ),
    ...
    titleImageSecondaryPositionXMobile: firstText(
      merged.titleImageSecondaryPositionXMobile,
      merged.titleImageSecondaryPositionXTablet,
      merged.titleImageSecondaryPositionX,
      defaultHeroSettings.titleImageSecondaryPositionXMobile,
    ),
    titleImageSecondaryPositionYMobile: firstText(
      merged.titleImageSecondaryPositionYMobile,
      merged.titleImageSecondaryPositionYTablet,
      merged.titleImageSecondaryPositionY,
      defaultHeroSettings.titleImageSecondaryPositionYMobile,
    ),
    ...
    heroTitlePositionXMobile: firstText(
      merged.heroTitlePositionXMobile,
      merged.heroTitlePositionXTablet,
      merged.heroTitlePositionX,
      defaultHeroSettings.heroTitlePositionXMobile,
    ),
    ...
    heroTitlePositionYMobile: firstText(
      merged.heroTitlePositionYMobile,
      merged.heroTitlePositionYTablet,
      merged.heroTitlePositionY,
      defaultHeroSettings.heroTitlePositionYMobile,
    ),
    ...
    heroTitleScaleMobile: numOr(merged.heroTitleScaleMobile, merged.heroTitleScaleTablet, merged.heroTitleScale, 1),
    ...
    presentationTextPositionXMobile: firstText(
      merged.presentationTextPositionXMobile,
      merged.presentationTextPositionXTablet,
      merged.presentationTextPositionX,
      defaultHeroSettings.presentationTextPositionXMobile,
    ),
    presentationTextPositionYMobile: firstText(
      merged.presentationTextPositionYMobile,
      merged.presentationTextPositionYTablet,
      merged.presentationTextPositionY,
      defaultHeroSettings.presentationTextPositionYMobile,
    ),
    ...
    presentationTextScaleMobile: numOr(
      merged.presentationTextScaleMobile,
      merged.presentationTextScaleTablet,
      merged.presentationTextScale,
      1,
    ),
    ...
    presentationImagePositionXMobile: firstText(
      merged.presentationImagePositionXMobile,
      merged.presentationImagePositionXTablet,
      merged.presentationImagePositionX,
      defaultHeroSettings.presentationImagePositionXMobile,
    ),
    presentationImagePositionYMobile: firstText(
      merged.presentationImagePositionYMobile,
      merged.presentationImagePositionYTablet,
      merged.presentationImagePositionY,
      defaultHeroSettings.presentationImagePositionYMobile,
    ),
    ...
    presentationImageScaleMobile: numOr(
      merged.presentationImageScaleMobile,
      merged.presentationImageScaleTablet,
      merged.presentationImageScale,
      1,
    ),
  };
}
