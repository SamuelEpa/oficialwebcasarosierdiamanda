...
export function IntroSlider({ slides }: { slides: readonly HomeIntroSlide[] }) {
  ...
  return (
    <section
      id="intro"
      className="home-intro-slider-marker relative box-border h-120 overflow-hidden bg-[#fbfaf6] pt-11.25 pb-16.5 max-[640px]:h-auto max-[640px]:min-h-125 max-[640px]:pt-9"
    >
      <Carousel
        items={visibleSlides}
