...
export function ShopItemDetailSection({
  ...
  return (
    <>
      <section className="shop-item-detail section py-[clamp(32px,4vw,56px)] pb-[clamp(48px,5vw,72px)]">
        <div className="shop-item-detail__container w-[min(100%-40px,1180px)] mx-auto">
